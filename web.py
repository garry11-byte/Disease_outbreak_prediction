...
diabetes_model = pickle.load(open(r"C:\Users\devda\OneDrive\Desktop\disesase outbreak project\training model\db_dataset.sav", 'rb'))
heart_disease_model = pickle.load(open(r"C:\Users\devda\OneDrive\Desktop\disesase outbreak project\training model\ht_dataset.sav", 'rb'))
parkinsons_model = pickle.load(open(r"C:\Users\devda\OneDrive\Desktop\disesase outbreak project\training model\pk_dataset.sav", 'rb'))
...
diabetes_model = pickle.load(open(r"C:\Users\devda\OneDrive\Desktop\disesase outbreak project\training model\db_dataset.sav", 'rb'))
heart_disease_model = pickle.load(open(r"C:\Users\devda\OneDrive\Desktop\disesase outbreak project\training model\ht_dataset.sav", 'rb'))
parkinsons_model = pickle.load(open(r"C:\Users\devda\OneDrive\Desktop\disesase outbreak project\training model\parkinsons_model.sav", 'rb'))
